...
with gzip.open('CCNCS_Internship/CNN/output_data/train_x.pickle', 'wb') as f:
    pickle.dump(train_x, f)

with gzip.open('CCNCS_Internship/CNN/output_data/train_y.pickle', 'wb') as f:
    pickle.dump(train_y, f)


with gzip.open('CCNCS_Internship/CNN/output_data/keyword_dict.pickle', 'wb') as f:
